...
- PDF section: 7.3.1
- Command name: エラー情報の読み取り
- Category: リーダライタ制御
- Command byte: 4Fh
- Detail command byte: 80h
- Subcommand byte: -
...
- Status: SUPPORTED
- Reason: PDF Ver.1.17 lists this command in section 7.3.1. AI/RAG organizes device, ROM, parameter, impact, response, and recovery conditions instead of deciding arbitrary non-use.
...
- Parameter constraints: Follow the field definitions in PDF section 7.3.1.
...
- ACK command: Use the command-specific ACK structure described in PDF section 7.3.1.
- Data length: See PDF section 7.3.1.
...
- Command-specific NACK notes: Check PDF section 7.3.1 and section 7.6 together.
...
- Command format source:
  - PDF 7.3.1
- ACK response source:
  - PDF 7.3.1 ACK response
- NACK response source:
  - PDF 7.6 common NACK; PDF 7.3.1 NACK response
