...
- PDF section: 7.3.11
- Command name: FLASH設定の初期化
- Category: リーダライタ制御
- Command byte: 4Eh
- Detail command byte: 6Fh
- Subcommand byte: -
...
- Reason: PDF Ver.1.17 lists this command in section 7.3.11. AI/RAG organizes device, ROM, parameter, impact, response, and recovery conditions instead of deciding arbitrary non-use.
...
- Parameter constraints: Follow the field definitions in PDF section 7.3.11.
...
- ACK command: Use the command-specific ACK structure described in PDF section 7.3.11.
- Data length: See PDF section 7.3.11.
...
- Command-specific NACK notes: Check PDF section 7.3.11 and section 7.6 together.
...
- Command format source:
  - PDF 7.3.11
- ACK response source:
  - PDF 7.3.11 ACK response
- NACK response source:
  - PDF 7.6 common NACK; PDF 7.3.11 NACK response
- Device/ROM support source:
  - PDF 6.2.1
- RAM/FLASH impact source:
  - PDF 7.3.11; docs/current/12_RAM_FLASH_IMPACT_MATRIX.md
