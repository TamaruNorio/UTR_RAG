...
- PDF section: 7.4.11
- Command name: 汎用ポート値の読み取り
- Category: リーダライタ設定
- Command byte: 4Fh
- Detail command byte: 9Fh
- Subcommand byte: -
...
- Status: SUPPORTED
- Reason: PDF Ver.1.17 lists this command in section 7.4.11. AI/RAG organizes device, ROM, parameter, impact, response, and recovery conditions instead of deciding arbitrary non-use.
...
- Parameter constraints: Follow the field definitions in PDF section 7.4.11.
...
- ACK command: Use the command-specific ACK structure described in PDF section 7.4.11.
- Data length: See PDF section 7.4.11.
...
- Command-specific NACK notes: Check PDF section 7.4.11 and section 7.6 together.
...
- Command format source:
  - PDF 7.4.11
- ACK response source:
  - PDF 7.4.11 ACK response
- NACK response source:
  - PDF 7.6 common NACK; PDF 7.4.11 NACK response
- Device/ROM support source:
  - PDF 6.2.2
- RAM/FLASH impact source:
  - PDF 7.4.11; docs/current/12_RAM_FLASH_IMPACT_MATRIX.md
...
- Latest result status:
  - REAL_DEVICE_PASS_WITH_NOTES
- Latest result notes:
  - v015 returned ACK. General port values were read; data_length=5.
