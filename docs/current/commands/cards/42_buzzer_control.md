...
- Reason: PDF Ver.1.17 lists this command in section 7.3.2. AI/RAG organizes device, ROM, parameter, impact, response, and recovery conditions instead of deciding arbitrary non-use.
...
- Parameter constraints: Follow the field definitions in PDF section 7.3.2.
...
- ACK command: Use the command-specific ACK structure described in PDF section 7.3.2.
- Data length: See PDF section 7.3.2.
...
- Command-specific NACK notes: Check PDF section 7.3.2 and section 7.6 together.
...
- Command format source:
  - PDF 7.3.2
- ACK response source:
  - PDF 7.3.2 ACK response
- NACK response source:
  - PDF 7.6 common NACK; PDF 7.3.2 NACK response
