...
- Reason: PDF Ver.1.17 lists this command in section 7.4.30. AI/RAG organizes device, ROM, parameter, impact, response, and recovery conditions instead of deciding arbitrary non-use.
...
- Parameter constraints: Follow the field definitions in PDF section 7.4.30.
...
- ACK command: Use the command-specific ACK structure described in PDF section 7.4.30.
- Data length: See PDF section 7.4.30.
...
- Command-specific NACK notes: Check PDF section 7.4.30 and section 7.6 together.
