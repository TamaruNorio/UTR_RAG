...
- PDF section: 7.4.1
- Command name: リーダライタ動作モードの読み取り
- Category: リーダライタ設定
- Command byte: 4Fh
- Detail command byte: 00h
- Subcommand byte: -
...
- Status: SUPPORTED
- Reason: PDF Ver.1.17 lists this command in section 7.4.1. AI/RAG organizes device, ROM, parameter, impact, response, and recovery conditions instead of deciding arbitrary non-use.
...
- Parameter constraints: Follow the field definitions in PDF section 7.4.1.
...
- ACK command: Use the command-specific ACK structure described in PDF section 7.4.1.
- Data length: See PDF section 7.4.1.
...
- Command-specific NACK notes: Check PDF section 7.4.1 and section 7.6 together.
...
- Command format source:
  - PDF 7.4.1
- ACK response source:
  - PDF 7.4.1 ACK response
- NACK response source:
  - PDF 7.6 common NACK; PDF 7.4.1 NACK response
- Device/ROM support source:
  - PDF 6.2.2
- RAM/FLASH impact source:
  - PDF 7.4.1; docs/current/12_RAM_FLASH_IMPACT_MATRIX.md
...
- Latest result status:
  - REAL_DEVICE_PASS_WITH_NOTES
- Latest result notes:
  - v015 returned ACK. Reader mode summary: command mode; data_length=9.
