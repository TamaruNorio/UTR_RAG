...
- Reason: PDF Ver.1.17 lists this command in section 7.4.20. AI/RAG organizes device, ROM, parameter, impact, response, and recovery conditions instead of deciding arbitrary non-use.
...
- UTR-SUN02V-8CH: Not supported by this command
- UTR-SUN02-8CH: Not supported by this command
- ROM/version notes: Use the product-appropriate antenna function.
...
- Parameter constraints: Follow the field definitions in PDF section 7.4.20.
...
- ACK command: Use the command-specific ACK structure described in PDF section 7.4.20.
- Data length: See PDF section 7.4.20.
...
- Command-specific NACK notes: Check PDF section 7.4.20 and section 7.6 together.
...
- Command format source:
  - PDF 7.4.20
- ACK response source:
  - PDF 7.4.20 ACK response
- NACK response source:
  - PDF 7.6 common NACK; PDF 7.4.20 NACK response
- Device/ROM support source:
  - PDF 6.2.2
- RAM/FLASH impact source:
  - PDF 7.4.20; docs/current/12_RAM_FLASH_IMPACT_MATRIX.md
- RF / carrier / antenna safety source:
  - PDF 3.1; PDF 7.4.20; docs/current/13_RF_SAFETY_AND_CARRIER_RULES.md
- Traceability status:
  - TRACE_COMPLETE
- Notes:
  - No completed Hex
