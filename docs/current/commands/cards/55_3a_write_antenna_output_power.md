...
- Reason: PDF Ver.1.17 lists this command in section 7.4.31. AI/RAG organizes device, ROM, parameter, impact, response, and recovery conditions instead of deciding arbitrary non-use.
...
- Parameter confirmation required: Target device series, ROM version, connection address, timeout policy, exact value, RAM or FLASH target, recovery method, connected antenna count, target antenna number, auto-switch range, transmit output, carrier state, carrier timing

## 5. Device / ROM support

- UTR-S201: ROM 2.100 or later
- UTR-SUN02-4CH: ROM 2.100 or later
- UTR-SHR201: ROM 2.100 or later
- UTR-SUN02V-8CH: ROM 2.100 or later
- UTR-SUN02-8CH: ROM 2.100 or later
- ROM/version notes: Read ROM version first.
...
- Parameters: Target device series, ROM version, connection address, timeout policy, exact value, RAM or FLASH target, recovery method, connected antenna count, target antenna number, auto-switch range, transmit output, carrier state, carrier timing
- Parameter constraints: Follow the field definitions in PDF section 7.4.31.
...
- ACK command: Use the command-specific ACK structure described in PDF section 7.4.31.
- Data length: See PDF section 7.4.31.
...
- Command-specific NACK notes: Check PDF section 7.4.31 and section 7.6 together.
...
- Required parameter confirmation: Target device series, ROM version, connection address, timeout policy, exact value, RAM or FLASH target, recovery method, connected antenna count, target antenna number, auto-switch range, transmit output, carrier state, carrier timing
...
- Command format source:
  - PDF 7.4.31
- ACK response source:
  - PDF 7.4.31 ACK response
- NACK response source:
  - PDF 7.6 common NACK; PDF 7.4.31 NACK response
- Device/ROM support source:
  - PDF 6.2.2
- RAM/FLASH impact source:
  - PDF 7.4.31; docs/current/12_RAM_FLASH_IMPACT_MATRIX.md
- RF / carrier / antenna safety source:
  - PDF 3.1; PDF 7.4.31; docs/current/13_RF_SAFETY_AND_CARRIER_RULES.md
- Traceability status:
  - TRACE_COMPLETE
- Notes:
  - No completed Hex
