...
- Status: SUPPORTED
- Reason: PDF Ver.1.17 lists this command in section 7.4.7. AI/RAG organizes device, ROM, parameter, impact, response, and recovery conditions instead of deciding arbitrary non-use.
...
- Parameter confirmation required: Target device series, ROM version, connection address, timeout policy, frequency channel, scan mode, Japan domestic operating condition
...
- Parameters: Target device series, ROM version, connection address, timeout policy, frequency channel, scan mode, Japan domestic operating condition
- Parameter constraints: Follow the field definitions in PDF section 7.4.7.
...
- ACK command: Use the command-specific ACK structure described in PDF section 7.4.7.
- Data length: See PDF section 7.4.7.
...
- Command-specific NACK notes: Check PDF section 7.4.7 and section 7.6 together.
...
- Required parameter confirmation: Target device series, ROM version, connection address, timeout policy, frequency channel, scan mode, Japan domestic operating condition
...
- Command format source:
  - PDF 7.4.7
- ACK response source:
  - PDF 7.4.7 ACK response
- NACK response source:
  - PDF 7.6 common NACK; PDF 7.4.7 NACK response
- Device/ROM support source:
  - PDF 6.2.2
- RAM/FLASH impact source:
  - PDF 7.4.7; docs/current/12_RAM_FLASH_IMPACT_MATRIX.md
- RF / carrier / antenna safety source:
  - PDF 3.1; PDF 7.4.7; docs/current/13_RF_SAFETY_AND_CARRIER_RULES.md
- Traceability status:
  - TRACE_COMPLETE
- Notes:
  - No completed Hex
...
- Latest result status:
  - REAL_DEVICE_PASS_WITH_NOTES
- Latest result notes:
  - v015 returned ACK using subcommand 02h and command-mode parameter kind 00h; no frequency change was performed.
