...
| 15 | 読み取り系確認が完了している | HOLD | 必須 | R8-3C実機確認 | 未実施 | R8-3BでNEEDS_SPEC_CONFIRMATIONのため実施対象外 |
| 16 | Inventory系確認が完了している | HOLD | 必須 | R8-3C実機確認 | 未実施 | R8-3BでNEEDS_SPEC_CONFIRMATIONのため実施対象外 |
...
| 24 | 実機確認結果が記録されている | PASS | 必須 | R8-3C記録フォーマット確認 | 記録済み | `docs/real_device/results/R8-3C_SAFE_REAL_DEVICE_CHECK_RESULT.md` に結果を記録 |
| 25 | ステータス取得系確認が完了している | HOLD | 必須 | R8-4レビュー | 未実施 | R8-3BでNEEDS_SPEC_CONFIRMATIONのため未実施 |
...
| 29 | リリース判断者が確認している | TODO | 必須 | 判断者レビュー | 未実施 | R8-5で判断 |
