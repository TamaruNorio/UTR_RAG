...
| 13 | 実機接続確認が完了している | TODO | 必須 | R8-3実機確認 | 未実施 | この変更では実施しない |
| 14 | 実機切断確認が完了している | TODO | 必須 | R8-3実機確認 | 未実施 | この変更では実施しない |
| 15 | 読み取り系確認が完了している | TODO | 必須 | R8-3実機確認 | 未実施 | 読み取り専用・非永続操作に限定 |
| 16 | タイムアウト時の挙動が確認されている | TODO | 必須 | R8-3実機確認 | 未実施 | ログ保存を含む |
| 17 | エラー時のログ確認ができる | TODO | 必須 | R8-3実機確認 | 未実施 | ログ保存先を記録 |
...
| 23 | 実機確認結果が記録されている | TODO | 必須 | R8-3記録フォーマット確認 | 未実施 | R8-3で記録 |
