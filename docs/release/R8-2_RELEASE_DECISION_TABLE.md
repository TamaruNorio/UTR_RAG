...
| 13 | 実機接続確認が完了している | HOLD | 必須 | R8-3実機確認 | 未実施 | 実機情報未確定のため接続開始なし |
| 14 | 実機切断確認が完了している | HOLD | 必須 | R8-3実機確認 | 未実施 | 接続未実施のため切断確認なし |
| 15 | 読み取り系確認が完了している | HOLD | 必須 | R8-3実機確認 | 未実施 | 対象コマンドと実機影響が未確定のため送信なし |
| 16 | タイムアウト時の挙動が確認されている | HOLD | 必須 | R8-3実機確認 | 未実施 | 接続未実施のためタイムアウト挙動未確認 |
| 17 | エラー時のログ確認ができる | HOLD | 必須 | R8-3実機確認 | 未実施 | 実機操作未実施のため実機ログなし |
